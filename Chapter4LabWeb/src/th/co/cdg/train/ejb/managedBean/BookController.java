...
public class BookController {
	...
	public void nativeQueryBookById(){
		bookListResult.add(bookNativeQueryLocal.queryBookById(book.getId()));
	}
	
	public void nativeQueryBookByCondition(){
		bookListResult = (bookNativeQueryLocal.queryBookByCondition(book));
	}
}
